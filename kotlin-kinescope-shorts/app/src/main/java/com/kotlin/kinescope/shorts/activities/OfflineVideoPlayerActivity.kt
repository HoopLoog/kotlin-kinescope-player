...
class OfflineVideoPlayerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val download = io.kinescope.sdk.shorts.download.VideoDownloadManager.getDownloadIndex(this).getDownload(downloadId)
        ...
        exoPlayer = io.kinescope.sdk.shorts.managers.PlayerFactory(this).createPlayer()
        initPlayerControls()

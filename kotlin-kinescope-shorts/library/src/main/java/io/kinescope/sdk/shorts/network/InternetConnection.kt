package io.kinescope.sdk.shorts.network
...
class InternetConnection(private val context: Context) {
    ...
    /**
     * Dashboard domain allow-list → CDN/API returns HTTP 403 / code 4030403 ("forbidden").
     * Media3 surfaces that as a generic Source / bad HTTP status error.
     */

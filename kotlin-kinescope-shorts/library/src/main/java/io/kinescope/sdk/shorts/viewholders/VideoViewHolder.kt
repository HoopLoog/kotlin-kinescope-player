package io.kinescope.sdk.shorts.viewholders
...
class VideoViewHolder(
    ...
    private fun startAggressiveProgressUpdates(contentId: String, videoData: VideoData) {
        var attempts = 0
        val maxFastAttempts = 25
        ...
        progressUpdateHandler.post(aggressiveRunnable)
    }

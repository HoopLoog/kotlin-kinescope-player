...
| Topic | File |
|-------|------|
| Player templates REST API | [docs/dashboard-api.md](docs/dashboard-api.md) |

### Offline

| Topic | File |
|-------|------|
| HLS/DASH downloads, Widevine offline | [docs/offline-downloads.md](docs/offline-downloads.md) |
